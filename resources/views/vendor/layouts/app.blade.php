...
<head>
  ...
  <title>Footwear- Shop @yield('pageTitle')</title>
    ...
    <div class="app-topstrip bg-dark py-6 px-3 w-100 d-lg-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center justify-content-center gap-5 mb-2 mb-lg-0">
        <a class="d-flex justify-content-center" href="#">
          <img src="{{asset('admin_assets/images/logos/logo-wrappixel.svg')}}" alt="" width="150">
        </a>
      </div>
    </div>
    <!-- Sidebar Start -->
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('vendor.dashboard')}}" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"
                href="{{route('vendor.product.index')}}" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"
                href="{{route('size.index')}}" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-shopping-cart"></i>
                  </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"
                href="{{route('product_size_stock.index')}}" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-shopping-cart"></i>
                  </span>
                  <span class="hide-menu">Product Size Stock</span>
                </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"
                href="{{route('vendor.order.index')}}" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-shopping-cart"></i>
                  </span>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="{{asset('admin_assets/images/profile/user-1.jpg')}}" alt="" width="35" height="35" class="rounded-circle">
                </a>
