    ...
    <div class="container-fluid">
        ...
        <div class="row">
          <h3>Add New Coupon</h3>
            ...
            <select name="discount_type"  class="form-control form-control-rounded" id="discount_type" value="{{$coupon->discount_type}}">
            ...
            <input type="date"  name="start_date"  class="form-control form-control-rounded" id="start_date" value="{{$coupon->start_date}}">
           </div>


           <div class="form-group">
            <label for="end_date">End Date</label>
            <input type="date"  name="end_date"  class="form-control form-control-rounded" id="end_date" value="{{$coupon->end_date}}">
           </div>
